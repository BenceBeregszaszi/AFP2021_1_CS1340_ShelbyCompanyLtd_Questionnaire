...
--
-- Table structure for table `próbanándinak`
--

CREATE TABLE `próbanándinak` (
  `id` int(11) NOT NULL COMMENT 'primary_key',
  `patient_name` varchar(255) COLLATE utf8_hungarian_ci NOT NULL COMMENT 'patient name',
  `'patient_TAJ` int(11) NOT NULL COMMENT 'patient TAJ',
  `patient_age` int(11) NOT NULL COMMENT 'patient age'
...
(16, 4, 'asd', 0, 0, 0, 0, 0, 0),
(17, 4, 'asd', 0, 0, 0, 0, 0, 0),
(18, 4, 'asd', 0, 0, 0, 0, 0, 0),
(19, 4, 'asd', 0, 0, 0, 0, 0, 0),
(20, 4, 'asd', 0, 0, 0, 0, 0, 0);
...
--
-- Indexes for table `próbanándinak`
--
ALTER TABLE `próbanándinak`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `próbanándinak`
--
ALTER TABLE `próbanándinak`
